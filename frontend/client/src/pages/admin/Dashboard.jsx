...
export default function Dashboard() {
  ...
  const cards = [
    { label: 'Total Enquiries', value: stats.enquiries, icon: '📩', to: '/admin/enquiries', color: 'bg-blue-50 border-blue-200 text-blue-700' },
    { label: 'New Enquiries', value: stats.newEnquiries, icon: '🔔', to: '/admin/enquiries', color: 'bg-orange-50 border-orange-200 text-orange-700' },
    { label: 'Services', value: stats.services, icon: '⚙️', to: '/admin/services', color: 'bg-green-50 border-green-200 text-green-700' },
    { label: 'Manage Content', value: 'Edit', icon: '📝', to: '/admin/content', color: 'bg-purple-50 border-purple-200 text-purple-700' }
  ];
    ...
    <div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {[
            { to: '/admin/enquiries', label: 'View All Enquiries', icon: '📩' },
            { to: '/admin/services', label: 'Edit Services', icon: '⚙️' },
            { to: '/admin/content', label: 'Update Content', icon: '📝' }
          ].map(a => (
